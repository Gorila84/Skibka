...
namespace gastrosalon
{
    ...
    public class GastrosalonModel
    {
        ...
        public string ZdjecieDodatkowe { get; set; }
        public string ZdjecieDodatkowe1 { get; set; }


        public string CenaAnetto { get; set; }
        ...
        public string Załacznik { get; set; }
        public string JednostkaMiary { get; set; }
        public string Waga { get; set; }
        public string f_wysokocs { get; set; }
        public string f_dlugosc { get; set; }
        public string f_glebokosc { get; set; }
